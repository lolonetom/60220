...
const test = async () => {
    await productManager.addProduct('producto prueba1', 'Este es un producto prueba', 200, 'Sin imagen', 'abc123', 10);
    await productManager.addProduct('producto prueba2', 'Este es un producto prueba', 300, 'Sin imagen', 'abc1234', 10);
    await productManager.addProduct('producto prueba1', 'Este es un producto prueba', 200, 'Sin imagen', 'abc123', 10);
